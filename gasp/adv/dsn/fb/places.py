...
def places_by_query(bfShp, epsgIn, keyword=None, epsgOut=4326,
    ...
    from gasp.adv.dsn.fb.search import by_query
    ...
    if onlySearchAreaContained:
        ...
        from gasp.gt.anls.prox.bf import coord_to_buffer
        ...
        search_area = proj(search_area, None, 4326, inEPSG=3857, gisApi='OGRGeom')
