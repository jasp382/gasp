...
def optimized_union_anls(lyr_a, lyr_b, outShp, ref_boundary, epsg,
    ...
    import os
    from gas3.pyt.oss      import get_filename
    from gasp.gt.sample    import create_fishnet
    from gasp.gt.wenv.grs  import run_grass
    from gasp.gt.to.shp    import eachfeat_to_newshp, shps_to_shp
    from gasp.gt.anls.exct import split_shp_by_attr
    ...
    if not multiProcess:
        ...
        # Export Data
        from gasp.gt.to.shp import grs_to_shp
