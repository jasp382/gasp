...
def obj_to_rst(inArray, outRst, template, noData=None):
    """
...
def folder_nc_to_tif(inFolder, outFolder):
    ...
    from gasp.gt.mng.split import gdal_split_bands
