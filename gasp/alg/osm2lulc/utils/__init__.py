...
from gasp.alg.osm2lulc.var import DB_SCHEMA, PROCEDURE_DB
...
def osm_project(osmDb, srs_epsg, api='SQLITE', isGlobeLand=None):
    ...
    if api != 'POSTGIS':
        ...
        from gasp.sql.mng.tbl  import q_to_ntbl as proj
        from gasp.sql.mng.geom import add_idx_to_geom
    from gasp.alg.osm2lulc.var import osmTableData, GEOM_AREA
...
def add_lulc_to_osmfeat(osmdb, osmTbl, nomenclature, api='SQLITE'):
    ...
    from gasp.alg.osm2lulc.var import DB_SCHEMA
...
def osmlulc_rsttbl(nomenclature, outpath):
    ...
    from gasp.alg.osm2lulc.var import LEGEND
