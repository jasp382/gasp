...
def osm2lulc(osmdata, nomenclature, refRaster, lulcRst,
    ...
    * POSTGIS
    ...
    from gasp.pyt.oss                import create_folder, copy_file
    from gasp.pyt.oss                import get_filename
    if roadsAPI == 'POSTGIS':
        from gasp.sql.db             import create_db
        from gasp.sql.to             import osm_to_pgsql
        from gasp.alg.osm2lulc.mod2  import pg_num_roads
    else:
        from gasp.alg.osm2lulc.utils import osm_to_sqdb
        from gasp.alg.osm2lulc.mod2  import num_roads
    from gasp.alg.osm2lulc.utils     import osm_project, add_lulc_to_osmfeat
    from gasp.alg.osm2lulc.utils     import osmlulc_rsttbl
    from gasp.alg.osm2lulc.utils     import get_ref_raster
    from gasp.alg.osm2lulc.mod1      import num_selection
    from gasp.alg.osm2lulc.m3_4      import num_selbyarea
    from gasp.alg.osm2lulc.mod5      import num_base_buffer
    from gasp.alg.osm2lulc.mod6      import num_assign_builds
    ...
    from gasp.alg.osm2lulc.var import osmTableData, PRIORITIES
