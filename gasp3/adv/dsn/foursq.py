...
def venues_by_query(radialShp, epsgIn, epsgOut=4326, onlySearchAreaContained=True):
    ...
    from gasp3.adv.dsn.foursq     import search_places
    ...
    if onlySearchAreaContained:
        ...
        searchArea = proj(searchArea, None, 4326, inEPSG=3857, gisApi='OGRGeom')
    ...
    if epsgOut != 4326:
        from gasp3.gt.prj import proj
        gdata = proj(gdata, None, epsgOut, gisApi='pandas')
