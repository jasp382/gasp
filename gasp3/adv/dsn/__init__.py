...
def dsn_data_collection_by_multibuffer(inBuffers, workspace, conParam, datasource,
    ...
    from gasp3.sql.to          import df_to_db, shp_to_psql
    from gasp3.gt.to.shp       import df_to_shp, dbtbl_to_shp
    from gasp3.gt.anls.prox.bf import get_sub_buffers, dic_buffer_array_to_shp
    
    if datasource == 'flickr':
        from gasp3.adv.dsn.flickr import photos_location
...
def dsnsearch_by_cell(GRID_PNT, EPSG, RADIUS, DATA_SOURCE, conpgsql, OUTPUT_TABLE):
    ...
    import time; from gasp3.fm   import tbl_to_obj
    from gasp3.sql.mng.db        import create_db
    from gasp3.adv.dsn.fb.places import places_by_query
