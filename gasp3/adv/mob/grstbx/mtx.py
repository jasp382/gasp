...
def prod_matrix(origins, destinations, networkGrs, speedLimitCol, onewayCol,
    ...
    from gasp3.gt.mob.grs        import network_from_arcs, add_pnts_to_network
    from gasp3.gt.mob.grs        import run_allpairs
...
def thrd_matrix_od(origins, destinationShp, network, costCol, oneway,
    ...
    * O programa baralha-se todo porque ha muitas sessoes do grass a serem 
    ...
    from gasp3.gt.mng.gen   import merge_feat
    from gasp3.gt.mng.split import splitShp_by_range
    ...
    from gasp3.gt.to.shp import grs_to_shp, grs_to_shp
    # Add Data to GRASS GIS
