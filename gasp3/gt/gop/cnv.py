...
def lnh_to_polygons(inShp, outShp, api='saga', con_db=None):
    ...
    * psql;
    ...
    if api == 'saga':
        ...
        from gasp3.gt.mng.feat import line_to_polyline
        from gasp3.gt.mng.feat import geomtype_to_geomtype
        from gasp3.gt.mng.feat import boundary_to_areas
        ...
        from gasp3.sql.gop.cnv import lnh_to_polg
